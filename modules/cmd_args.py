...
parser.add_argument("--embeddings-dir", type=normalized_filepath, default=os.path.join(models_path, 'embeddings'), help="embeddings directory for textual inversion (default: embeddings)")
